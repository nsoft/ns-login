 ...
 * upon {@link Filter#init(FilterConfig)} and
 * {@link Filter#destroy()} respectively.
 *
 ...
 * <p>
 *   Original version Copyright (C) 2010 Google, Inc.
 *   <pre>
 *     Licensed under the Apache License, Version 2.0 (the "License");
 *     you may not use this file except in compliance with the License.
 *     You may obtain a copy of the License at
 ...
 *     limitations under the License.
 *   </pre>
 *   changes available via diff with
 *   https://raw.githubusercontent.com/google/guice/master/extensions/persist/src/com/google/inject/persist/PersistFilter.java
 *
 * @author Dhanji R. Prasanna (dhanji@gmail.com)
 */
@Singleton
public final class PersistFilter implements Filter {
  private final Provider<UnitOfWork> unitOfWork;
  private final ThreadLocal<UnitOfWork> uow = new ThreadLocal<UnitOfWork>() {
    @Override
  ...
  @Inject
  public PersistFilter(Provider<UnitOfWork> unitOfWork, PersistService persistService) {
